...
# Load the dataset
    ...
    d_train = utils_general_porpose.load_json(current_dir, "/train/train_20250520_053753.json")
    ...
    d_test = utils_general_porpose.load_json(current_dir, "/test/test_20250520_053753.json")
