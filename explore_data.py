...
def plot_frequency_distribution_of_ngrams_v2(sample_texts,
                                          ngram_range=(1, 2),
                                          num_ngrams=50):
    ...
    # vocabulary, where every element indicates the count of the n-gram
    ...
    # Adjust xticks to show all n-grams
    plt.xticks(idx, ngrams, rotation=90, fontsize=8)
    plt.tight_layout()  # Ensure everything fits in the plot
    plt.show()

    return all_ngrams, all_counts
